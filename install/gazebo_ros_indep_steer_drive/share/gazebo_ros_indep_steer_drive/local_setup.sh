...
: ${AMENT_CURRENT_PREFIX:="/home/robostep/nav2-sample/install/gazebo_ros_indep_steer_drive"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gazebo_ros_indep_steer_drive/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gazebo_ros_indep_steer_drive/environment/path.sh"
